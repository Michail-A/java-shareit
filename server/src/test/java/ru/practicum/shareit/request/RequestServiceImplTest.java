...
class RequestServiceImplTest {
    ...
    void getRequestsByOwner() {
        ...
        GetRequestDto actual = RequestMapper.mapToGetRequestDto(request);
        actual.setItems(List.of(ItemMapper.mapToRequestDtoItemGet(item)));
        assertEquals(getRequestDtos.get(0), actual);
    }
