...
public class ItemMapper {
    ...
    public static ItemRequestDtoItemGet toItemRequestDtoItemGet(Item item) {
        return ItemRequestDtoItemGet.builder()
                .id(item.getId())
                .name(item.getName())
                .description(item.getDescription())
                .available(item.getAvailable())
    ...
    public static Item toNewItem(ItemDtoAdd itemDtoAdd, User user, ItemRequest itemRequest) {
        return Item.builder()
